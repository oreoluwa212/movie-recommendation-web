      ...
      <div className="container mx-auto px-4 space-y-8 pt-8">
        ...
        {loadingStates.popular || isLoadingPopular ? (
          ...
          <MovieSection
            ...
            cardSize="medium"
            onRetry={() => fetchWithErrorHandling(getPopularMovies, "popular")}
          />
        )}
        ...
        {!isAuthenticated && (
          <section className="bg-gradient-to-r from-red-600 to-red-800 rounded-lg p-8 text-center my-12">
            ...
            <p className="text-red-100 mb-6 max-w-2xl mx-auto">
              Create an account to receive personalized movie recommendations,
              build your watchlists, and track your favorite movies.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() => useAuthStore.getState().setCurrentView("login")}
