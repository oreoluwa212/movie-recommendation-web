...
export const useProfile = () => {
  ...
  // ADDED: Ensure full profile is loaded
  const ensureFullProfileLoaded = async () => {
    if (!profile && minimalProfile) {
      // We have minimal profile but not full profile, load it
  ...
  return {
    ...
    ensureFullProfileLoaded, // NEW: Helper to ensure full profile is loaded
